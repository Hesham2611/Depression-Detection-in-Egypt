...
def get_image_filepath(self, filename):
	return 'image/' + str(self.pk) + '/image.png'
...
class Profile(models.Model):
    ...
    image = models.ImageField(default='OnChat.png', upload_to='profile_pics',blank=True, null=True)
    following_relatives = models.ManyToManyField(User, related_name="following_relatives", blank=True)
    is_depressed=models.BooleanField(default=False)
